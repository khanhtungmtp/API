...
public class Repository<T, BaseAdminContext>(BaseAdminContext context) : IRepository<T> where T : class where BaseAdminContext : DbContext
{
    private readonly BaseAdminContext _context = context;
